...
namespace Buyonida_T2.Controllers
{
    ...
    public class UserAccountController : ControllerBase
    {
        ...
        public UserAccountController(IUserService userService, ILogger<UserAccountController> logger, UserManager<AppUser> userManager, IMailService mailService, ITokenService tokenService)
        {
